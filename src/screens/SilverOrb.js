...
export default function Orb({
  ...
  const frag = /* glsl */ `
    ...
    // צבעים מותאמים לכסף
    const vec3 baseColor1 = vec3(0.9, 0.9, 0.95);     // כסף בהיר
    const vec3 baseColor2 = vec3(0.7, 0.7, 0.8);      // כסף בינוני
    const vec3 baseColor3 = vec3(0.4, 0.4, 0.5);      // כסף כהה
  ...
  useEffect(() => {
    ...
    const update = (t) => {
      ...
      if (rotateOnHover && effectiveHover > 0.5) {
        currentRot += dt * rotationSpeed * 2; // רוטציה מהירה יותר בהובר
      }
